...
@Data
public class WeixinPayJsUnifiedResquestData {
    // 每个字段具体的意思请查看API文档
    ...
    public WeixinPayJsUnifiedResquestData(String appId, String mchId, String openId,
                                          String description, String outTradeNo, String timeExpire,
        ...
        this.payer = new Payer().setOpenid(openId);
